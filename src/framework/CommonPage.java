...
public class CommonPage{
	...
	AppiumDriver driver;
	static Logger logger = Logger.getLogger(CommonPage.class);
	...
	public boolean setPage( String pageName) throws Exception {
						try {
	...
	public void touch( String ctrlName) throws Exception
	{
		try {
			...
			ExtentReportManager.getTest().log(LogStatus.INFO, ExtentReportManager.getTest().addScreenCapture(CommonPage.capture(driver, "TouchFailure")));
	...
	public void enterText( String ctrlName,  String value) throws Exception {
						try {
							webEle = getControl(ctrlName);
							webEle.clear();
							...
							ExtentReportManager.getTest().log(LogStatus.INFO, ExtentReportManager.getTest().addScreenCapture(CommonPage.capture(driver, "EntetTest failure")));
	...
	public String elementGettext(String ctrlName)
			throws Exception {
						...
						try {
							...
							ExtentReportManager.getTest().log(LogStatus.INFO, ExtentReportManager.getTest().addScreenCapture(CommonPage.capture(driver, "Element get failure")));
	...
	public void swipeDown( String ctrlName) throws Exception
	{
		try {
			Map ctrlInfo = PageControlMap.objectInfo
					.get(ctrlName);
